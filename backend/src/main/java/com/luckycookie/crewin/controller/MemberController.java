...
public class MemberController {
    ...
    public ResponseEntity<BaseResponse<MemberProfileResponse>> getMemberProfile(@AuthenticationPrincipal CustomUser customUser, @PathVariable("member-id") Long memberId) {
