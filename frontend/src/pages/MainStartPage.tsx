    ...
    <>
      <div className="bg-gray-100 sm:bg-white relative pb-1">
        ...
        <div className="mx-1 bg-white rounded-xl my-1 pb-4 pt-3">
          ...
          <div className="mt-3 font-medium sm:font-semibold text-[15px] sm:text-xl text-gray-500 ms-3">
            찾아 헤매지 말고 지역, 이름으로 간편한 크루 검색
          </div>
          <div className="mb-3 font-medium sm:font-semibold text-[15px] sm:text-xl text-gray-500 ms-3">
            크루들은 어떻게 활동하고 있을까?
          </div>
          <div
