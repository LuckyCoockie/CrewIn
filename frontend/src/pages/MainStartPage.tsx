...
const StartPage: React.FC = () => {
    ...
    return (
        <>
            <div className="bg-gray-100 relative pb-1">
                <img
                ...
                <div className="mx-1 bg-white rounded-xl my-1 pb-4 pt-3">
                    ...
                    >
                        <img src={mainrunningposter1} alt="additionalOne" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainrunningposter2} alt="additionalTwo" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainrunningposter3} alt="additionalThree" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainrunningposter4} alt="additionalFour" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainrunningposter5} alt="additionalFive" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainrunningposter6} alt="additionalSix" className="w-72 h-72 object-cover rounded-lg" />
                    </div>
                </div>
                ...
                <div className="mx-1 bg-white rounded-xl my-2 pb-4 pt-3">
                    ...
                    <div
                        ...
                        className="flex overflow-x-scroll space-x-4 py-2 snap-x snap-mandatory scrollbar-hide"
                    >
                        <img src={mainsessionposter1} alt="additionalOne" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainsessionposter2} alt="additionalTwo" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainsessionposter3} alt="additionalThree" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainsessionposter4} alt="additionalFour" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainsessionposter5} alt="additionalFive" className="w-72 h-72 object-cover rounded-lg" />
                        <img src={mainsessionposter6} alt="additionalSix" className="w-72 h-72 object-cover rounded-lg" />
                    </div>
                </div>

                {/* 하단 중앙에 고정된 버튼 */}
                <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full bg-white pb-4 px-4 pt-2" style={{ maxWidth: '500px' }}>
